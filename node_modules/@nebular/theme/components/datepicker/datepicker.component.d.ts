import { ComponentFactoryResolver, ComponentRef, ElementRef, EventEmitter, OnDestroy, Type } from '@angular/core';
 ...
 * */
export declare abstract class NbBasePicker<D, T, P> extends NbDatepicker<T> implements OnDestroy {
